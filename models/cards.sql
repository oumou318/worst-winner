...
('In an effort to be more popular, the Girl Scouts have recently added a badge for _____.'),
('The good news: _____. The bad news: _____.'),
('We''re starting a boyband called _____. You''re gonna be the _____.'),
('Now in theatres: Quentin Tarantino''s _____, starring _____ as _____.'),
('I''m looking forward to nuclear fallout, because _____.'),
